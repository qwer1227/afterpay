        ...
        <div class="col-10">
            <form id="addrForm" method="post">
                ...
                <table class="table text-center">
                    ...
                    %>
                    <tr>
                        <td><input type="checkbox" style="zoom: 1.5" id="check-addr" name="addrNo"
                                   value="<%=addr.getNo()%>"
                                   data-default-addr="<%=addr.getIsAddrHome()%>"></td>
                        <td>
                            <%
                ...
                <div class="row mb-3">
                    <div class="col-6 text-start">
                        <button type="button" onclick="changeDefaultAddr()" id="change-default-addr"
                    ...
                    <div class="col-6 text-end">
                        ...
                        <button type="button" name="btn-addr" id="update-addr" class="btn btn-outline-warning"
                                onclick="modifyform()">
...
<script>
    ...
    function changeDefaultAddr() {
        ...
        if (checkBox) {
            ...
            // 기본 배송지 변경 로직
            let form = document.getElementById('addrForm');
            form.setAttribute("action", "/user/change-isaddr-home.jsp");

            // 새로운 기본 주소 번호를 폼에 추가
            let newDefaultAddrNo = checkBox.value;
            let input = document.createElement("input");
            input.type = "hidden";
            input.name = "newDefaultAddrNo";
            input.value = newDefaultAddrNo;
