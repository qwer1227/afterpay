...
<div class="container">
  <div class="row">
    <div class="col-2"></div>
    <div class="col-10">
      <h2 class="mt-3"><strong>주문 내역</strong></h2>
    </div>
  </div>
  <div class="row">
    <div class="col-2">
    ...
    <div class="col-10">
      ...
      <div class="text-center m-5">
        ...
        <br>
        <button type="button" onclick="location.href='../index.jsp'" class="btn btn-lg bg-light border-dark-subtle">지금
          바로 쇼핑하러 가기
        </button>
      </div>
      <%
        ...
        <table class="table">
          ...
          <tr class="align-middle">
            ...
            <td class="text-center">
              ...
              <div><a href="../order/order-form.jsp?stockNo=<%=stock.getNo()%>&amount=<%=delivery.getAmount()%>"
                      type="button" class="btn mt-1 btn-outline-primary">재 구 매</a></div>
              <div>
                <a href="../order/order-cancel.jsp.?stockNo=<%=stock.getNo()%>&amount=<%=delivery.getAmount()%>&orderNo=<%=order.getNo()%>"
                   type="button" class="btn mt-1 btn-outline-primary">재 구 매</a></div>
